...
class RLTuner(ModelBasedTuner):
    ...
    def __init__(self, task, cost_model='xgb', rnn_params=None, plan_size=64,
                 ...
                 optimizer='rl', sampler="adaptive", diversity_filter_ratio=None, log_interval=50):
        ...
        super(RLTuner, self).__init__(task, cost_model, optimizer, plan_size, diversity_filter_ratio)
